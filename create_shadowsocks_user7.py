...
def process_telegram_updates():
    ...
    "از اینکه ربات ما را برای استفاده از این سرویس انتخاب کرده‌اید، خوشحالیم!\n"
    "اکنون می‌توانید از اکانت تست یک ساعته خود برای آزمایش سرویس استفاده کنید و از کیفیت آن اطمینان حاصل کنید.\n\n"
    
    "🕒 *مهلت تست اکانت شما: ۱ ساعت*\n"
    "در این مدت می‌توانید از سرویس به‌صورت کامل استفاده کنید و اگر از عملکرد آن راضی بودید، "
    "برای خرید اشتراک یک ماهه اقدام کنید.\n\n"
